            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                   ...
                   @if (in_array('ADM',$rolesUser))
                    ...
                    @if (in_array('ADM', $rolesUser))
                        <li><a href="{{route('transaksi')}}" aria-expanded="false"><i class="icon icon-single-04"></i><span
                                    class="nav-text">Users</span></a></li>
                    @endif
                    @if (in_array('CST',$rolesUser))
                    <li><a href="{{route('riwayatTransaksi',auth()->user()->id)}}" aria-expanded="false"><i class="icon icon-single-04"></i><span
                    class="nav-text">Riwayat Transaksi</span></a></li>
                    @endif
